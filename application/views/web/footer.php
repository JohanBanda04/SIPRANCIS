    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-12 c-col">
          <p class="c-copyright c-font-grey">Sub Bidang AHU Kanwil Kemenkumham NTB 
            <span class="c-font-grey-3">&#169; cucoh.cibal <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script></span>
          </p>
        </div>
      </div>
    </div>
