    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading"><h4 class="panel-title">Informasi Anggota MKN</h4></div>
                <div class="panel-body">
                    <p>Selamat datang, <?= ucwords($cek->username); ?>. Fitur pengajuan dan monitoring surat tersedia sesuai wewenang Anda.</p>
                </div>
            </div>
        </div>
    </div>
